...
export default {
  ...
  data() {
    return {
      bubbles: [
        { text: 'This', colorClass: 'is-pastel-red', x: 10, y: 35, size: 150, delay: 0 },
        { text: 'is', colorClass: 'is-pastel-green', x: 70, y: 10, size: 120, delay: 2 },
        { text: 'the', colorClass: 'is-pastel-blue', x: 1, y: 12, size: 105, delay: 1 },
        { text: 'private', colorClass: 'is-pastel-green', x: 55, y: 30, size: 110, delay: 3 },
        { text: 'board', colorClass: 'is-pastel-red', x: 15, y: 70, size: 130, delay: 4 },
        { text: 'for', colorClass: 'is-pastel-blue', x: 80, y: 60, size: 100, delay: 2.5 },
        { text: 'deco2850', colorClass: 'is-pastel-green', x: 70, y: 80, size: 115, delay: 1.5 },
        { text: 'RAWR', colorClass: 'is-pastel-green', x: 40, y: 80, size: 200, delay: 1.5 },
      ],
...
.topbar {
  ...
  right: 0;
  height: 72px;
  background: #eab580; /* soft cyan like photo */
